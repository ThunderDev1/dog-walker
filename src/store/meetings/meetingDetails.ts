...
export interface MeetingDetailsState {
  meeting: Meeting;
  isLoading: boolean;
  goingBtnLoading: boolean;
  nogoBtnLoading: boolean;
}
...
export type MeetingDetailsActionTypes = LoadMeetingStartAction | LoadMeetingSuccessAction | LoadMeetingFailureAction;
...
const initialState: MeetingDetailsState = {
  ...
  isLoading: false,
  goingBtnLoading: false,
  nogoBtnLoading: false,
};
